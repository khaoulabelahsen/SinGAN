...
if __name__ == '__main__':
    ...
    #    print("output already exist")
        ...
        opt.mode = 'Denoising' #changed it from train
        ...
        #for j in range(0,1):
            for k in range(int(opt.stop_scale),1):
                ...
                Gs_sr.append(Gs[int(opt.denoise_scale)+k]) #+ instead of -
        ...
        #dir2save = functions.generate_dir2save(opt)
        plt.imsave('%s/%s_denoising_boucle.png' % ('Output',opt.input_name[:-4]), functions.convert_image_np(out.detach()), vmin=0, vmax=1)